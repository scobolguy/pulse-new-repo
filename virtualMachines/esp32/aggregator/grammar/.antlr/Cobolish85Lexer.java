...
public class Cobolish85Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"END_PROGRAM", "END_CALL", "END_IF", "END_EVALUATE", "END_PERFORM", "END_EXEC", 
			"END", "AT", "BY", "DELIMITED", "INTO", "INPUT", "OUTPUT", "AFTER", "ADVANCING", 
			"ALSO", "ANY", "PROGRAM_ID", "IDENTIFICATION", "ENVIRONMENT", "CONFIGURATION", 
			"INPUT_OUTPUT", "DATA", "PROCEDURE", "DIVISION", "SECTION", "WORKING_STORAGE", 
			"FILE", "LINKAGE", "LOCAL_STORAGE", "REPORT", "SCREEN", "SPECIAL_NAMES", 
			"SOURCE_COMPUTER", "OBJECT_COMPUTER", "LIBRARIAN", "SELECT", "ASSIGN", 
			"TO", "ORGANIZATION", "ACCESS", "MODE", "RECORD", "KEY", "FILE_STATUS", 
			...
			"COMP_3", "COMP_4", "COMP_5", "DISPLAY", "PACKED_DECIMAL", "FROM", "GIVING", 
			"PERFORM", "VARYING", "UNTIL", "CALL", "IF", "THEN", "ELSE", "EVALUATE", 
			"OTHER", "MOVE", "SET", "OPEN", "CLOSE", "READ", "WRITE", "START", "DELETE", 
			"COMPUTE", "ADD", "SUBTRACT", "MULTIPLY", "DIVIDE", "STRING", "GOBACK", 
			"STOP", "RUN", "INTEROP", "WFL", "PASCALISH", "COBOLISH", "LIBRARY", 
			"USE", "AS", "REPLACING", "COPY", "EXEC", "CONTINUE", "USING", "REFERENCE", 
			"CONTENT", "RETURNING", "EXCEPTION", "AND", "OR", "I_O", "EXTEND", "LINES", 
			"PAGE", "HEADING", "FOOTING", "CONTROL", "TRUE", "FALSE", "SPACE", "SPACES", 
			"QUOTES", "NOT", "LEVEL_77", "LEVEL_NUMBER", "DOT", "COMMA", "LPAREN", 
			"RPAREN", "PLUS", "MINUS", "MUL", "DIV", "EQ", "LT", "GT", "LE", "GE", 
			"NEQ", "NOT_EQ", "NUMBER", "STRING_LITERAL", "IDENTIFIER", "WS", "COMMENT", 
			"LINE_COMMENT"
		};
	}
	...
	public static final String _serializedATN =
		...
		"\u00a9\u0001\u0000 \u0002\u0000EEee\u0002\u0000NNnn\u0002\u0000DDdd\u0002"+
		"\u0000PPpp\u0002\u0000RRrr\u0002\u0000OOoo\u0002\u0000GGgg\u0002\u0000"+
		"AAaa\u0002\u0000MMmm\u0002\u0000CCcc\u0002\u0000LLll\u0002\u0000IIii\u0002"+
		"\u0000FFff\u0002\u0000VVvv\u0002\u0000UUuu\u0002\u0000TTtt\u0002\u0000"+
		"XXxx\u0002\u0000BBbb\u0002\u0000YYyy\u0002\u0000SSss\u0002\u0000WWww\u0002"+
		"\u0000KKkk\u0002\u0000JJjj\u0002\u0000ZZzz\u0002\u0000HHhh\u0002\u0000"+
		"QQqq\u0001\u000009\u0005\u0000\n\n\r\r\"\"\'\'\\\\\u0002\u0000AZaz\u0005"+
		"\u0000--09AZ__az\u0003\u0000\t\n\r\r  \u0002\u0000\n\n\r\r\u0711\u0000"+
		"\u0001\u0001\u0000\u0000\u0000\u0000\u0003\u0001\u0000\u0000\u0000\u0000"+
