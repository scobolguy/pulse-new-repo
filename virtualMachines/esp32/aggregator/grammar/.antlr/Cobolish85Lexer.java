...
public class Cobolish85Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"END_PROGRAM", "END_CALL", "END_IF", "END_COMPUTE", "END_EVALUATE", "END_PERFORM", 
			"END_EXEC", "END", "ROUNDED", "SIZE", "ERROR", "AT", "BY", "DELIMITED", 
			"INTO", "INPUT", "OUTPUT", "AFTER", "ADVANCING", "ALSO", "ANY", "PROGRAM_ID", 
			"IDENTIFICATION", "ENVIRONMENT", "CONFIGURATION", "INPUT_OUTPUT", "DATA", 
			"PROCEDURE", "DIVISION", "SECTION", "WORKING_STORAGE", "FILE", "LINKAGE", 
			"LOCAL_STORAGE", "REPORT", "SCREEN", "SPECIAL_NAMES", "SOURCE_COMPUTER", 
			"OBJECT_COMPUTER", "LIBRARIAN", "PULSE", "SERVICE", "SEND", "DAEMON", 
			"PROGRAM", "EVERY", "LOCAL", "PARENT", "CHILD", "SIBLING", "ALTERNATE", 
			"MS", "S", "M", "SELECT", "ASSIGN", "TO", "ORGANIZATION", "ACCESS", "MODE", 
			"SEQUENTIAL", "RELATIVE", "DYNAMIC", "RANDOM", "RECORD", "KEY", "FILE_STATUS", 
			"BLOCK", "CONTAINS", "CHARACTERS", "RECORDS", "LABEL", "OMITTED", "STANDARD", 
			"PIC", "PICTURE", "VALUE", "OCCURS", "TIMES", "DEPENDING", "ON", "REDEFINES", 
			"RENAMES", "THROUGH", "THRU", "USAGE", "IS", "SYNCHRONIZED", "JUSTIFIED", 
			"RIGHT", "BLANK", "WHEN", "ZERO", "ZEROS", "SIGN", "LEADING", "TRAILING", 
			"SEPARATE", "CHARACTER", "INDEXED", "BINARY", "COMP", "COMP_1", "COMP_2", 
			"COMP_3", "COMP_4", "COMP_5", "DISPLAY", "INDEX", "PACKED_DECIMAL", "FROM", 
			"GIVING", "PERFORM", "VARYING", "UNTIL", "CALL", "IF", "THEN", "ELSE", 
			"EVALUATE", "OTHER", "MOVE", "SET", "OPEN", "CLOSE", "READ", "WRITE", 
			"ACCEPT", "START", "DELETE", "COMPUTE", "ADD", "SUBTRACT", "MULTIPLY", 
			"DIVIDE", "STRING", "GOBACK", "STOP", "RUN", "INTEROP", "WFL", "PASCALISH", 
			"COBOLISH", "ROLE", "CODE_LIBRARIAN", "LIBRARY", "USE", "IMPORT", "MAPPER", 
			"MAPPER_ENTRY", "MAP_RULE", "MAPPING", "SOURCE_TYPE", "TARGET_TYPE", 
			"ROUTE", "USING", "BEGIN_KW", "AS", "REPLACING", "COPY", "EXEC", "CONTINUE", 
			"REFERENCE", "CONTENT", "RETURNING", "EXCEPTION", "AND", "OR", "I_O", 
			"EXTEND", "LINES", "LINE", "COLUMN", "PAGE", "HEADING", "FOOTING", "CONTROL", 
			"TRUE", "FALSE", "SPACE", "SPACES", "QUOTES", "NOT", "SECOND", "SECONDS", 
			"LEVEL_77", "LEVEL_NUMBER", "DOT", "COMMA", "LPAREN", "RPAREN", "PLUS", 
			"MINUS", "MUL", "DIV", "EQ", "LT", "GT", "LE", "GE", "NEQ", "NOT_EQ", 
			"NUMBER", "STRING_LITERAL", "DOTTED_PATH", "IDENTIFIER", "WS", "COMMENT"
		};
	}
	...
	public Cobolish85Lexer(CharStream input) {
		super(input);
	...
	public static final String _serializedATN =
		...
		"\u018d\u00c7\u018f\u00c8\u0191\u00c9\u0193\u00ca\u0195\u00cb\u0197\u00cc"+
		"\u0199\u00cd\u019b\u00ce\u019d\u00cf\u019f\u00d0\u0001\u0000 \u0002\u0000"+
		"EEee\u0002\u0000NNnn\u0002\u0000DDdd\u0002\u0000PPpp\u0002\u0000RRrr\u0002"+
		"\u0000OOoo\u0002\u0000GGgg\u0002\u0000AAaa\u0002\u0000MMmm\u0002\u0000"+
		"CCcc\u0002\u0000LLll\u0002\u0000IIii\u0002\u0000FFff\u0002\u0000UUuu\u0002"+
		"\u0000TTtt\u0002\u0000VVvv\u0002\u0000XXxx\u0002\u0000SSss\u0002\u0000"+
		"ZZzz\u0002\u0000BBbb\u0002\u0000YYyy\u0002\u0000WWww\u0002\u0000KKkk\u0002"+
		"\u0000JJjj\u0002\u0000HHhh\u0002\u0000QQqq\u0001\u000009\u0005\u0000\n"+
		"\n\r\r\"\"\'\'\\\\\u0002\u0000AZaz\u0005\u0000--09AZ__az\u0006\u0000#"+
		"#--09@Z__az\u0003\u0000\t\n\r\r  \u088b\u0000\u0001\u0001\u0000\u0000"+
		"\u0000\u0000\u0003\u0001\u0000\u0000\u0000\u0000\u0005\u0001\u0000\u0000"+
