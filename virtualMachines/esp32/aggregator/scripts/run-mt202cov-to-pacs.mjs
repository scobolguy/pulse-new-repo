...
async function main() {
  ...
  const mapping = mappings.find((m) => m.id === 'mt202cov-to-pacs');
  if (!mapping) throw new Error('Mapping mt202cov-to-pacs not found');
  ...
  const outPath = path.join(ROOT, 'data', 'mt202cov-to-pacs-output.xml');
